<template>
  <div class="l-card-container" @click="cardHandle">
    <img v-show="record.src" data-src="" :src="record.src"/>
    <div v-show="!record.src" class="image-icon-box">
...
<script>
  export default {
    ...
    methods: {
      cardHandle() {
        this.$emit('onCardHandle', this.record)
      }
    }
  }
</script>
